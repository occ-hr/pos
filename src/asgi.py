# src/asgi.py
# the ASGI entrypoint (defines create_app() and app = create_app() so Uvicorn can launch) for the service. (Potential place for top-level router inclusion, static mounts, and middleware setup.)
...
Run with:
    uvicorn asgi:app --app-dir src --reload
"""
